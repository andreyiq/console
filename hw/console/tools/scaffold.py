...
# выводов и номеров — примерно x 236..358, y 145..261.
#
# Рамкам нужен коридор шире: у выводов F133 стоят глобальные метки, а метка
# рисуется стрелкой длиной под свой текст. Самая длинная слева — «LDOA-OUT»,
# её текст доходит до x = 218.4, поэтому правый край блока 4 отодвинут на 214.
# Справа «VCC-TVOUT» кончается на 376.4 при рамках блоков 5 и 6 на 378.
#
