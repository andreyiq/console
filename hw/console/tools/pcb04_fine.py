...
def crystals(board):
    ...
    * **кварцы** уходят на ряд дальше, за развязку, но остаются напротив
    ...
    """
    n = 0
    for ref, x, y, rot in (("U401", 44.0, 41.0, 0),      # SPI NOR у выводов 14…19
                           ("Y1", 38.0, 34.6, 0),        # 24 МГц, выводы 22/23
                           ("Y2", 45.0, 28.8, 0),        # 32.768 кГц, выводы 24/25
                           ("C15", 32.0, 33.2, 0),       # нагрузочные 24 МГц
                           ("C16", 32.0, 36.0, 0),
                           ("C17", 38.5, 27.5, 0),       # нагрузочные 32 кГц
                           ("C18", 38.5, 30.4, 0)):
